...
function _complete_imagetool() {
  ...
  local cmds3=(rebase)
  local cmds4=(help)
  local cmds5=(cache listItems)
  local cmds6=(cache addInstaller)
  local cmds7=(cache addPatch)
  local cmds8=(cache addEntry)
  local cmds9=(cache deleteEntry)
  local cmds10=(cache help)

  if CompWordsContainsArray "${cmds10[@]}"; then _picocli_imagetool_cache_help; return $?; fi
  if CompWordsContainsArray "${cmds9[@]}"; then _picocli_imagetool_cache_deleteEntry; return $?; fi
  if CompWordsContainsArray "${cmds8[@]}"; then _picocli_imagetool_cache_addEntry; return $?; fi
  if CompWordsContainsArray "${cmds7[@]}"; then _picocli_imagetool_cache_addPatch; return $?; fi
  if CompWordsContainsArray "${cmds6[@]}"; then _picocli_imagetool_cache_addInstaller; return $?; fi
  if CompWordsContainsArray "${cmds5[@]}"; then _picocli_imagetool_cache_listItems; return $?; fi
  if CompWordsContainsArray "${cmds4[@]}"; then _picocli_imagetool_help; return $?; fi
...
function _picocli_imagetool() {
  ...
  local commands="cache create update rebase help"
...
function _picocli_imagetool_create() {
  ...
  local commands=""
  local flag_opts="--skipcleanup --dryRun --latestPSU --recommendedPatches --pull --skipOpatchUpdate --wdtRunRCU --wdtModelOnly --wdtStrictValidation"
  local arg_opts="--tag --user --password --passwordEnv --passwordFile --httpProxyUrl --httpsProxyUrl --docker --chown --additionalBuildCommands --additionalBuildFiles --patches --opatchBugNumber --buildNetwork --vzModel --packageManager --type --version --jdkVersion --fromImage --installerResponseFile --inventoryPointerFile --inventoryPointerInstallLoc --wdtModel --wdtArchive --wdtVariables --wdtVersion --wdtDomainType --wdtDomainHome --wdtJavaOptions --wdtModelHome --wdtEncryptionKey --wdtEncryptionKeyEnv --wdtEncryptionKeyFile"
  local packageManager_option_args="OS_DEFAULT NONE YUM DNF MICRODNF APTGET APK ZYPPER" # --packageManager values
  local installerType_option_args="WLSSLIM WLSDEV WLS FMW OSB SOA SOA_OSB IDM IDM_WLS OAM OIG OUD OUD_WLS WCC WCP WCS" # --type values
...
function _picocli_imagetool_update() {
  ...
  local commands=""
  local flag_opts="--skipcleanup --dryRun --latestPSU --recommendedPatches --pull --skipOpatchUpdate --wdtRunRCU --wdtModelOnly --wdtStrictValidation"
  local arg_opts="--tag --user --password --passwordEnv --passwordFile --httpProxyUrl --httpsProxyUrl --docker --chown --additionalBuildCommands --additionalBuildFiles --patches --opatchBugNumber --buildNetwork --vzModel --packageManager --fromImage --wdtOperation --wdtModel --wdtArchive --wdtVariables --wdtVersion --wdtDomainType --wdtDomainHome --wdtJavaOptions --wdtModelHome --wdtEncryptionKey --wdtEncryptionKeyEnv --wdtEncryptionKeyFile"
  local packageManager_option_args="OS_DEFAULT NONE YUM DNF MICRODNF APTGET APK ZYPPER" # --packageManager values
...
function _picocli_imagetool_rebase() {
  ...
  local commands=""
  local flag_opts="--skipcleanup --dryRun --latestPSU --recommendedPatches --pull --skipOpatchUpdate"
  local arg_opts="--tag --user --password --passwordEnv --passwordFile --httpProxyUrl --httpsProxyUrl --docker --chown --additionalBuildCommands --additionalBuildFiles --patches --opatchBugNumber --buildNetwork --vzModel --packageManager --type --version --jdkVersion --sourceImage --targetImage --installerResponseFile --fromImage --inventoryPointerFile --inventoryPointerInstallLoc"
  local packageManager_option_args="OS_DEFAULT NONE YUM DNF MICRODNF APTGET APK ZYPPER" # --packageManager values
  local installerType_option_args="WLSSLIM WLSDEV WLS FMW OSB SOA SOA_OSB IDM IDM_WLS OAM OIG OUD OUD_WLS WCC WCP WCS" # --type values
...
function _picocli_imagetool_help() {
  ...
  local commands="cache create update rebase"
...
function _picocli_imagetool_cache_addInstaller() {
  ...
  local commands=""
  local flag_opts=""
  local arg_opts="--type --version --path"
  local type_option_args="wlsdev wlsslim wls fmw soa osb idm oam oud wcc wcp wcs jdk wdt" # --type values
...
function _picocli_imagetool_cache_addPatch() {
  ...
  local commands=""
  local flag_opts=""
  local arg_opts="--patchId --type --path"
